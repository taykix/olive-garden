...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // redirect('/pending') handled server-side when no confirmation needed
  }
        ...
        <div className="w-full max-w-[380px] space-y-7">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="full_name" className="text-gray-700 text-sm font-medium">Ad Soyad</Label>
              <Input id="full_name" name="full_name" placeholder="Adınız Soyadınız" required
                className="h-11 border-gray-200 bg-white focus-visible:ring-green-500 focus-visible:border-green-400" />
            </div>

            <div className="space-y-1.5">
              <Label htmlFor="apartment_no" className="text-gray-700 text-sm font-medium">Daire No</Label>
              <Input id="apartment_no" name="apartment_no" placeholder="örn: A-5" required
                className="h-11 border-gray-200 bg-white focus-visible:ring-green-500 focus-visible:border-green-400 uppercase" />
            </div>

            <div className="space-y-1.5">
              <Label htmlFor="email" className="text-gray-700 text-sm font-medium">E-posta</Label>
              <Input id="email" name="email" type="email" placeholder="ornek@email.com" required autoComplete="email"
                className="h-11 border-gray-200 bg-white focus-visible:ring-green-500 focus-visible:border-green-400" />
            </div>

            <div className="space-y-1.5">
              <Label htmlFor="password" className="text-gray-700 text-sm font-medium">Şifre</Label>
              <Input id="password" name="password" type="password" placeholder="En az 6 karakter" required minLength={6} autoComplete="new-password"
                className="h-11 border-gray-200 bg-white focus-visible:ring-green-500 focus-visible:border-green-400" />
            </div>
